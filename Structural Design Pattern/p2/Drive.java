...
public class Drive implements Component {
    ...
    public Drive(String name, String parentDirectory) {
        this.name = name + ":\\";
        ...
        directory = parentDirectory + "/" + this.name;
    }
    ...
    public Component makeDrive(String name) {
        System.out.println("Error: You cannot create a drive inside another drive");
        return this;
    }
